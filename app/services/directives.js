(function () {
    ...
    app.directive('ccImgPerson', ['config',
        function (config) {
            // <img data-cc-img-person="{{ s.speaker.imageSource }}"/>
            var basePath = config.imageSettings.imageBasePath,
                unknownImage = config.imageSettings.unknownPersonImageSource,
                directive = {
                link: link,
                restrict: 'A'
            };
            ...
            function link(scope, elem, attr, ctrl) {
                attr.$observe('ccImgPerson', function(val){
                    val = basePath + (val || unknownImage);
                    attr.$set('src', val);
                })
            }
        }
